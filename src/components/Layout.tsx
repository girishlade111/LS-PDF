        ...
        <header className="flex items-center justify-between px-4 md:px-8 h-16 md:h-20 border-b border-gray-100 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md sticky top-0 z-[100]">
          <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
            ...
            <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity shrink-0">
              <LsPdfLogo size={Capacitor.isNativePlatform() ? 24 : 28} iconColor="#F43F5E" />
              <span className="font-black tracking-tighter text-lg md:text-xl dark:text-white hidden xs:block">LS PDF</span>
            </Link>
          ...
          <div className="flex items-center gap-1 md:gap-3 shrink-0">
            {isMobileBrowser && (
              <a 
                href="https://github.com/girishlade111/LS-PDF/releases/latest" 
                target="_blank"
            ...
            <div className="grid grid-cols-2 md:grid-cols-12 gap-8 mb-12">
              ...
              <div className="col-span-2 md:col-span-6 space-y-4">
                ...
                <div className="flex items-center gap-2 pt-1">
                   ...
                   <a href="https://github.com/girishlade111/LS-PDF" target="_blank" className="p-2 bg-gray-50 dark:bg-zinc-900 rounded-xl hover:bg-rose-500 hover:text-white transition-all text-gray-500 dark:text-zinc-500">
                     <GHIcon size={14} />
                   </a>
                </div>
              </div>
              ...
              <div className="col-span-1 md:col-span-3">
                ...
                <ul className="space-y-2.5 text-xs text-gray-500 dark:text-zinc-500">
                  ...
                  <li><a href="https://github.com/girishlade111/LS-PDF/blob/main/LICENSE" target="_blank" className="hover:text-rose-500 transition-colors">License</a></li>
                </ul>
              </div>
