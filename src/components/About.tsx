/**
 * LS PDF - About & Protocol Specification
      ...
      <section className="relative pt-20 pb-12 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-500 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
            LS PDF is an absolute document engine. No servers, no tracking, no compromises. We transform your browser into a self-contained document laboratory.
          </p>
        </div>
      </section>
        ...
        <div className="bg-rose-500 text-white rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-xl shadow-rose-500/20">
           ...
           <div className="flex-1 text-center md:text-left relative z-10">
              ...
              <p className="text-rose-100 font-medium text-base mb-6 max-w-xl leading-relaxed">
                 LS PDF is self-funded and ad-free. Your support ensures the project stays alive and free for everyone.
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-gray-500 dark:text-zinc-400 text-sm font-medium leading-relaxed">
              LS PDF rejects the trade-off between convenience and privacy. We've built an engine that runs where the user is, ensuring your sensitive data never crosses a network boundary.
            </p>
            <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-sm">
               ...
               <p className="text-xs text-gray-500 dark:text-zinc-400 font-medium leading-relaxed">
                   We operate no backend. No databases. No file caches. LS PDF is a static distribution of code that activates your browser's existing power.
               </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 bg-white dark:bg-zinc-900 rounded-[2.5rem] p-2 md:p-6 border border-gray-100 dark:border-white/5 shadow-sm">
             <SpecItem title="How it Works" icon={CpuIcon} defaultOpen={true}>
                 Every action is executed locally on your device's CPU. Using high-performance <span className="text-rose-500 font-bold">Web Workers</span> and <span className="text-rose-500 font-bold">WebAssembly</span>, LS PDF loads your PDF into a sandboxed environment within your browser tab.
             </SpecItem>
             ...
             <SpecItem title="Radical Transparency" icon={CodeIcon}>
                 LS PDF is <span className="text-rose-500 font-bold">100% Open Source</span> under the <span className="text-rose-500 font-bold">GNU AGPL v3</span> license. This gives you the right to audit every line of code and guarantees the engine remains free.
             </SpecItem>
    ...
    <NativeToolLayout title="Protocol" description="System Internals" actions={null}>
      <div className="px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-4">
        ...
        <div className="bg-rose-500 text-white rounded-[2rem] p-6 relative overflow-hidden shadow-xl shadow-rose-500/20">
           ...
           <div className="relative z-10">
              ...
              <p className="text-sm font-medium text-rose-100 leading-relaxed mb-6">
                 We are 100% self-funded. Your support ensures LS PDF stays free and open for everyone.
              </p>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-2 border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden">
           ...
           <div className="divide-y divide-gray-50 dark:divide-white/5 px-2">
              <SpecItem title="How it Works" icon={CpuIcon}>
                Every action you perform—merging, splitting, or encrypting—happens locally on your device's CPU. LS PDF uses an internal local engine powered by <span className="text-rose-500 font-bold">pdf-lib</span> and <span className="text-rose-500 font-bold">WebAssembly</span>. No data ever leaves your hardware.
              </SpecItem>
              ...
              <SpecItem title="Deep Metadata Clean" icon={DiskIcon}>
                Privacy isn't just about servers. Most tools leave digital breadcrumbs in the PDF metadata. LS PDF's "Deep Clean" protocol sanitizes every document, purging Producer, Creator, and XMP metadata to ensure absolute anonymity.
              </SpecItem>

              <SpecItem title="Open Source Integrity" icon={CodeIcon}>
                Trust is earned through transparency. LS PDF is <span className="text-rose-500 font-bold">100% open-source</span> under the <span className="text-rose-500 font-bold">GNU AGPL v3</span> license. This ensures the engine remains free, auditable, and community-driven forever.
              </SpecItem>
        ...
        <div className="grid grid-cols-1 gap-2 pt-2">
          <a href="https://github.com/girishlade111/LS-PDF" target="_blank" className="flex items-center justify-between p-5 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-[2rem] active:scale-[0.98] transition-all">
