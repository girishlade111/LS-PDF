<p align="center">
  <img src="public/icons/logo-github.svg" width="120" alt="LS PDF Logo">
</p>
...
[![Web App](https://img.shields.io/badge/web-live-emerald.svg)](https://potatameister.github.io/ls-pdf/)
...
I built **LS PDF** to solve this. It's a collection of tools that run entirely in your browser or on your phone. Your files never leave your memory, they aren't stored in any database, and no server ever sees them. It works 100% offline.
...
*   **On the Web:** Visit the [live site](https://potatameister.github.io/ls-pdf/). You can use it like any other website, or "install" it as a PWA for offline access.

---

### Support the project

LS PDF is a solo project. It's open-source, ad-free, and tracker-free because I believe privacy is a right, not a luxury.
...
LS PDF is built with **React** and **TypeScript**. The core processing is handled by **pdf-lib** and **pdfjs-dist**, which run in a sandboxed environment using WebAssembly. The Android version is powered by **Capacitor**.
